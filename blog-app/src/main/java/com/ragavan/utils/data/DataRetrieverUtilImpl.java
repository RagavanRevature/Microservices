package com.ragavan.utils.data;
...
public class DataRetrieverUtilImpl {
	...
	public <E> List<E> retrieveByHQL(String queryString, QueryProperties queryProperties) throws DataAccessException {
		List<E> objects = null;
		try {
			Session session = sessionFactory.getCurrentSession();
			if (queryString != null) {
		...
		try {
			...
			if (queryString != null) {
				...
				for (QueryParameter<?> queryParameter : queryParameters) {
					if (queryParameter.getValue() != null && (queryParameter.getValue().getClass().equals(List.class)
	...
	public <E> List<E> retrieveBySQL(String queryString, QueryProperties queryProperties) throws DataAccessException {
		List<E> objects = null;
		try {
			Session session = sessionFactory.getCurrentSession();
			if (queryString != null) {
